...
export default function Sidebar() {
  ...
  return (
    <div className="sidebar">
      <div className="flex flex-col w-full bg-cyan-700 rounded-lg py-6">
        ...
        <h2 className="p-1 text-2xl text-center text-black">
          <Link to='myprofile' className="bg-orange-300 rounded-lg py-0.5 px-4 hover:bg-orange-400 my-6">
        ...
        <div className="flex flex-row mx-auto ">
          ...
          <p className="pb-1 text-white text-center">{checkKindlyPoints(myData.kindlyScore)}</p>
        </div>
        {/* end of points */}
        {/* location */}
        <div className="mb-7">
        ...
        <div className="w-5/6 mx-auto mb-2 text-center bg-sky-100 border-4 border-orange-300 rounded-lg p-1 max-h-96">
          <h2 className="mb-1 underline bg-orange-300 py-2 rounded-lg text-xl font-bold">Your Upcoming Events</h2>
        </div>
          ...
          {myEvents.map(event => (
            <a key={event._id} className="bg-sky-100" href="#">
              <div className="p-1 text-left my-4 rounded-lg bg-sky-200 hover:bg-sky-300">
                ...
                <p className="text-sky-900"><b>Location:</b> {event.location}</p>
                <p className="text-sky-900"><b>Date: </b>{event.date}</p>
        ...
        <div className="w-5/6 mx-auto mb-2 text-center bg-sky-100 border-4 border-orange-300 rounded-lg p-1 max-h-96">
          <h2 className="mb-1 underline bg-orange-300 py-2 rounded-lg text-xl font-bold">Your Upcoming Good Deeds</h2>
        </div>
          ...
          {myGoodDeeds.map(goodDeed => (
            <a key={goodDeed._id} className="bg-sky-100" href="#">
              <div className="p-1 text-left my-4 rounded-lg bg-sky-200 hover:bg-sky-300">
                ...
                <p className="text-sky-900"><b>Location:</b> {goodDeed.location}</p>
